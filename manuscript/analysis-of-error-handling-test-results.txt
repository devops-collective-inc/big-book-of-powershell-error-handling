...
As mentioned in the introduction, the test code and its output files are available for download from the same location where you got this ebook ( [http://PowerShell.org/wp/ebooks](http://PowerShell.org/wp/ebooks) for the link). It's quite a bit of data, and doesn't format very well in a Word document, so I won't be including the contents of those files in this ebook. If you question any of the analysis or conclusions I've presented in this section, I encourage you to download and review both the code and results files.
